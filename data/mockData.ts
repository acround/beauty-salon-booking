import { Service, Specialist, Booking, Publication, User, PublicationType, Role, Review, ScheduleChangeRequest, ScheduleChangeRequestStatus } from '../types';
...
const generateCurrentMonthSchedule = () => {
    ...
    const specialist1Schedule: Record<string, string[]> = {};
    const specialist2Schedule: Record<string, string[]> = {};
...
export const mockNews: Publication[] = [
    {
        id: 'n1',

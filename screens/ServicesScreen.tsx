...
import { Service, Specialist, Language, LocalizedString } from '../types';
...
const ServicesScreen: React.FC<ServicesScreenProps> = ({ t, lt, services, specialists, onBook, onShowDetail }) => {
    
    // FIX: Explicitly type the accumulator for the reduce function to prevent type inference issues.
    const categories = services.reduce<Record<string, Service[]>>((acc, service) => {
...
const ServiceCard: React.FC<{
    ...
    onBook: (service: Service) => void,
    onShowDetail: (service: Service) => void
}> = ({ service, t, lt, onBook, onShowDetail }) => {

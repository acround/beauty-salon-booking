...
import { Booking, Service, Specialist, User, Review, LocalizedString } from '../types';
...
interface MyBookingsScreenProps {
    ...
    onAddReview: (bookingId: string, specialistId: string, newReview: Omit<Review, 'id' | 'isModerated'>) => void;
    currentUser: User;
}

const MyBookingsScreen: React.FC<MyBookingsScreenProps> = ({ t, lt, bookings, services, specialists, setBookings, onAddReview, currentUser }) => {
    const now = new Date();
...
const BookingCard: React.FC<{
    ...
    lt: (localizedString: LocalizedString) => string;
    isUpcoming?: boolean;
}> = ({ booking, services, specialists, onCancel, onReview, t, lt, isUpcoming }) => {

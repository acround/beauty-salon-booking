...
// These interfaces are not part of standard DOM typings and need to be declared for TypeScript to recognize them.
...
const TranslatedInput: React.FC<TranslatedInputProps> = ({ label, value, onChange, isTextarea = false }) => {
